...
struct analytics
{
    IXSystemAnalytics IXSystemAnalytics_iface;
    LONG ref;
};

static inline struct analytics *impl_from_IXSystemAnalytics( IXSystemAnalytics *iface )
{
    return CONTAINING_RECORD( iface, struct analytics, IXSystemAnalytics_iface );
}

static HRESULT WINAPI analytics_QueryInterface( IXSystemAnalytics *iface, REFIID iid, void **out )
{
    struct analytics *impl = impl_from_IXSystemAnalytics( iface );
    ...
    {
        IXSystemAnalytics_AddRef( *out = &impl->IXSystemAnalytics_iface );
        return S_OK;
    }
...
static ULONG WINAPI analytics_AddRef( IXSystemAnalytics *iface )
{
    struct analytics *impl = impl_from_IXSystemAnalytics( iface );
...
static ULONG WINAPI analytics_Release( IXSystemAnalytics *iface )
{
    struct analytics *impl = impl_from_IXSystemAnalytics( iface );
...
static XSystemAnalyticsInfo* WINAPI analytics_XSystemGetAnalyticsInfo( IXSystemAnalytics *iface, XSystemAnalyticsInfo *__ret )
{
...
static const struct IXSystemAnalyticsVtbl analytics_vtbl =
{
    analytics_QueryInterface,
    analytics_AddRef,
    analytics_Release,
    /* IXSystemAnalytics methods */
    analytics_XSystemGetAnalyticsInfo,
};

static struct analytics analytics =
{
    {&analytics_vtbl},
    0,
};

IXSystemAnalytics *analytics_impl = &analytics.IXSystemAnalytics_iface;
